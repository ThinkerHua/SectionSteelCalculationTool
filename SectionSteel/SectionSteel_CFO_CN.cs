 ...
 *==============================================================================
 *  SectionSteel_CFO_CN.cs: 冷弯开口型钢（Cold forming open section steel）内卷边槽钢
...
namespace SectionSteel {
    ...
    /// <see cref="Pattern_Collection.CFO_CN_1"/>: <inheritdoc cref="Pattern_Collection.CFO_CN_1"/><br/>
    /// <see cref="Pattern_Collection.CFO_CN_2"/>: <inheritdoc cref="Pattern_Collection.CFO_CN_2"/><br/>
    /// </summary>
    public class SectionSteel_CFO_CN : SectionSteelBase {
        ...
        protected override void SetFieldsValue(SectionSteelBase sender, ProfileTextChangingEventArgs e) {
            try {
                ...
                Match match = Regex.Match(e.NewText, Pattern_Collection.CFO_CN_1);
                if (!match.Success)
                    match = Regex.Match(e.NewText, Pattern_Collection.CFO_CN_2);
                if (!match.Success)
                    throw new MismatchedProfileTextException(e.NewText);
