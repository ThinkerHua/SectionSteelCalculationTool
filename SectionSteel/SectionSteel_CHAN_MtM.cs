...
namespace SectionSteel {
    ...
    /// <see cref="Pattern_Collection.CHAN_MtM_1"/>: <inheritdoc cref="Pattern_Collection.CHAN_MtM_1"/><br/>
    /// <see cref="Pattern_Collection.CHAN_MtM_2"/>: <inheritdoc cref="Pattern_Collection.CHAN_MtM_2"/><br/>
    /// </summary>
        ...
        protected override void SetFieldsValue(SectionSteelBase sender, ProfileTextChangingEventArgs e) {
            ...
            try {
                ...
                if (match.Success) {
                    ...
                    match = Regex.Match(e.NewText, Pattern_Collection.CHAN_MtM_2);
                    if (!match.Success)
                        throw new MismatchedProfileTextException(e.NewText);
